...
#ifdef PORT
// In PORT mode, skip __asm__ .incbin includes.
// These would be generated by the N64 toolchain.
// For now, define symbols as empty arrays.

#define INCLUDE_IMG(FILENAME, SYMBOLNAME) \
    unsigned char SYMBOLNAME[] = {0};

#define INCLUDE_PAL(FILENAME, SYMBOLNAME) \
    unsigned short SYMBOLNAME[] = {0};
...
#define INCLUDE_PAL(FILENAME, SYMBOLNAME) \
    ...
    __asm__( \
        ...
        ".type \"" #SYMBOLNAME"\", @object\n" \
        #SYMBOLNAME":\n" \
        ".incbin \"ver/" ASTRINGIFY(VERSION) "/build/" ASTRINGIFY(VERSION) "/" FILENAME "\"\n" \
        POPSECTION \
    )
